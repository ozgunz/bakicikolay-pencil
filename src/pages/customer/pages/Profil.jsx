...
const userInfo = {
  memberId: 'BK-2025-04821', // üye ID
  registrationDate: '2025-11-15', // kayıt tarihi
  firstName: 'Ayşe', // ad
  lastName: 'Yılmaz', // soyad
  email: 'ayse.yilmaz@email.com',
  phone: '0532 123 45 67', // telefon
  address: 'Caferağa Mah. Moda Cad. No:42 D:5', // adres
  district: 'Kadıköy', // ilçe
  city: 'İstanbul', // il
};
  ...
  return (
    <CustomerLayout title="Profilim - BakıcıKolay">
      <div className="max-w-2xl">
        ...
        {/* Üyelik bilgileri (Membership info) */}
