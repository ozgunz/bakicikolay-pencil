...
const reviews = [
  {
    ...
    caregiver: 'Fatma Demir',
    rating: 5, // puan
    comment: 'Fatma Hanım annemin bakımında çok özenli ve sabırlı. Kendisini gönül rahatlığıyla tavsiye ederim.', // yorum
    date: '2026-02-20',
  },
  {
    id: 2,
...
const caregiverInfo = {
  name: 'Fatma Demir', // ad
  expertise: 'Yaşlı & Hasta Bakımı', // uzmanlık
  experience: '8 yıl', // deneyim
  phone: '0532 *** ** 90', // telefon
  email: 'f***@email.com',
  location: 'İstanbul, Kadıköy', // konum
  rating: 4.9, // puan
  startDate: '2025-11-15', // başlama tarihi
  avatar: 'FD',
};

// Durum renkleri (Status colors)
const statusColors = {
  active: { bg: '#ECFDF5', text: '#059669', label: 'Aktif' }, // aktif
  pending: { bg: '#FFFBEB', text: '#D97706', label: 'Beklemede' }, // beklemede
  completed: { bg: '#F0F0FF', text: 'var(--color-primary)', label: 'Tamamlandı' }, // tamamlandı
};
