...
const typeIcons = {
  request: { icon: ClipboardList, color: 'var(--color-primary)', bg: 'var(--color-primary-soft)' },
  caregiver: { icon: UserCheck, color: '#22C55E', bg: '#ECFDF5' },
  review: { icon: MessageSquare, color: 'var(--color-accent-gold)', bg: '#FFFBEB' },
  system: { icon: Settings, color: 'var(--color-text-muted)', bg: 'var(--color-bg)' },
                ...
                {recentNotifications.map((notification) => {
                  ...
                  return (
                    <button
                      ...
                      onClick={() => {
                        setOpen(false);
                        router.visit(`/customer/bildirimler?highlight=${notification.id}`);
                      }}
